  ...
  const testimonials = [
    {
      name: "Priya Sharma",
      content:
        "Finally found something that actually works! No more manual timestamp removal for me.",
      rating: 5,
    },
    {
      name: "James Mitchell",
      content:
        "This saved me so much time on my thesis. Was spending hours transcribing lectures manually before this.",
      rating: 5,
    },
    {
      name: "Ahmed Hassan",
      content:
        "Perfect for my YouTube channel. Need clean text for subtitles and this makes it super easy.",
      rating: 5,
    },
  ];
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-6 max-w-3xl mx-auto">
                Turn any YouTube video into clean text in seconds - no more
                messy timestamps!
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Extract",
                description:
                  "Click the extract button and we'll process the video transcript",
              },
              {
                step: "3",
                title: "Download",
                description:
                  "Get your clean transcript and download in your preferred format",
              },
            ].map((step, index) => (
              <motion.div
                key={index}
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-6 max-w-2xl mx-auto">
              A simple, free tool to extract clean transcripts from YouTube
              videos. No signup required.
            </p>
